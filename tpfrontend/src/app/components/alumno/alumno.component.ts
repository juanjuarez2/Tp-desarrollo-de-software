...
@Component({
  ...
  export class AlumnoComponent implements OnInit {
      ...
      if (this.alumnoForm.valid) {
        ...
        if (this.editing && this.currentAlumnoId) {
          ...
          this.alumnoService.update(this.currentAlumnoId, alumno).subscribe(() => {
            this.getAllAlumnos();  // Actualizamos la lista de alumnos
    ...
    editAlumno(alumno: Alumno): void {
      ...
      this.currentAlumnoId = alumno.id;  // Guardamos el ID del alumno que estamos editando
    }
    ...
    resetForm(): void {
      ...
      this.currentAlumnoId = null;  // Limpiamos el ID del alumno en edición
    }
